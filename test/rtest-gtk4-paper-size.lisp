...
(test paper-size-new-from-ppd.3
...
(test paper-size-new-from-ipp.1
...
(test paper-size-new-from-ipp.2
...
(test paper-size-default-margins
  (let ((paper-size (gtk:paper-size-new "iso_a4")))
    ;; GtkUnit is :points
