...
(def-suite gtk-window :in gtk-windows)
(in-suite gtk-window)
...
(test gtk-window-toplevels
  ...
  (glib-test:with-check-memory (window1 window2 window3 :strong 1)
    (is-false (gtk:window-list-toplevels))
    (setf window1 (make-instance 'gtk:window))
    (setf window2 (make-instance 'gtk:application-window))
    (setf window3 (make-instance 'gtk:about-dialog))
    (is (typep (gtk:window-toplevels) 'g:list-store))
    (is (= 3 (g:list-store-n-items (gtk:window-toplevels))))
    ...
    (is (= 0 (g:list-store-n-items (gtk:window-toplevels))))
    (is-false (gtk:window-list-toplevels))))
...
(test gtk-window-list-toplevels
  ...
  (dolist (window (gtk:window-list-toplevels))
    (gtk:window-destroy window))
  (is-false (gtk:window-list-toplevels))
  (glib-test:with-check-memory (window1 window2 window3)
    (setf window1 (make-instance 'gtk:window))
    (setf window2 (make-instance 'gtk:application-window))
    (setf window3 (make-instance 'gtk:about-dialog))
