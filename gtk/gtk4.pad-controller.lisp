...
(setf (documentation 'pad-controller 'type)
 "@version{#2020-9-11}
  @begin{short}
    The @sym{gtk:pad-controller} class is an event controller for the pads
...
pad_controller = gtk_pad_controller_new (window, action_group, NULL);
  ...
  \"d\" type bearing the value of the given axis, it
  is required that those are made stateful and accepting this
  @symbol{glib:variant-type}.
...
#+liber-documentation
(setf (documentation (liber:slot-documentation "pad"
                                               'pad-controller) t)
