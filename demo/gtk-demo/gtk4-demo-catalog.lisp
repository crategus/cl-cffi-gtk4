   ...
   '(("GTK 4 Lisp Demo"
     ...
     (("CSS Accordion"                                      ; Title
      ...
      ("CSS Style classes"
       ...
       "gtk4-example"
       "css-style-classes.lisp"
       "resource/css-style-classes.ui"
       :keywords
       ))
     ...
     (("Simple Window"
      ...
      ("About Dialog"
       ...
       (("About Dialog Variant 1"
         ":dialog"
         "CREATE-ABOUT-DIALOG"
         "gtk4-example"
         "about-dialog.lisp")
        ("About Dialog Variant 2"
         ":dialog"
     ...
     (("Application Launcher"
      ...
      ("Recent Manager"
       ...
       "gtk4-example"
       "list-view-recent-manager.lisp"
       "resource/dialog-recent-info.ui"
       :keywords
       "GtkListView"
       "gtk:list-view"
       "gtk:list-view-new"
       ...
       "GtkRecentManger"
       "gtk:recent-manager"
       "gtk:recent-manager-default"
       "gtk:recent-manager-items"
       "GtkRecentInfo"
       "gtk:recent-info"
       "::setup"
       "::bind"
      ...
      ("Content Types"
       ...
       "gtk4-example"
       "column-view-content-types.lisp"
       :keywords
       "GtkColumnView"
       "gtk:column-view"
       "gtk:column-view-append"
       "gtk:column-view-cell-item"
       "gtk:colum-view-column-new"
       ...
       "g:content-type-description"
       "gtk:string-list-new"
       "gtk:string-object-string"
       "gtk:image-set-from-gicon"
       "g:app-info-icon"
       "g:app-info-display-name"
       "g:app-info-default-for-type-async"
       "g:app-info-default-for-type-finish"
       "::setup"
       "::bind")
      ("Unicode Character Database"
       ...
       "DO-column-view-ucd"
       "gtk4-example"
       "column-view-ucd.lisp"
       "resource/dialog-unicode.ui"
       :keywords
       "GtkColumnView"
       "gtk:column-view"
      )
...
; TODO: This example is not finished
     ...
     (("Drawing Area"
      ...
      ("Knockout Groups"
       ...
       "gtk4-example"
       "drawing-area-knockout-groups.lisp"
       :keywords
       "GtkDrawingArea"
       "gtk:drawing-area")
      ("Paint"
     ...
     (#-windows
      ("Page Setup Dialog"
       ...
       "gtk:page-setup-unix-dialog-page-setup"))
